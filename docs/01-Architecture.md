...
| TrueNAS backup-hub capacity is finite | Media pool measured 92% used on 2026-09-22; backup freshness and capacity alerts remain active while the separate six-drive expansion is tested. |
...
design and validation detail: `docs/handovers/UPS-Power-Resilience-Claude-Handover.md`.
