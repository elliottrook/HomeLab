...
| Grafana | Native OIDC — complete and tested (2026-09-15) | `monitoring.elliottrook.com` | Direct owner binding; group-derived Grafana organization Admin role; local server administrator and login form retained as break-glass |
