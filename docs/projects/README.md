...
| Aster ARR stack manager | Active — bounded read/repair graduated | [Aster ARR stack manager](Aster-Arr-Stack-Manager.md) | Source-aware ARR advisor with sanitized live evidence and one separately approved brokered Radarr queue-record repair |
