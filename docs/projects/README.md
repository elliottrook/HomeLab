...
| Aster Home Assistant advisor | Active — graduation in progress | [Aster Home Assistant advisor](Aster-Home-Assistant.md) | Instance-specific curriculum, strict sanitized live report and adversarial graduation suite; no Home Assistant credential or mutation authority |
