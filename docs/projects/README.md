...
| Prometheus/Grafana observability | Prometheus pilot complete; Grafana pilot next | [Prometheus/Grafana](Prometheus-Grafana-Observability.md) | Seven bounded scrape jobs are healthy; existing HomeLab Doctor and Beszel remain operational |
