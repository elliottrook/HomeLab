...
|---|---|---|---|
| Aster Adaptive Computing — Foundation and First Evidence Loop | Active — Stream A; M0 verified; M1 Stage1 installed and verified; Stage2 assurance open | [Implementation project](AI%20Projects/Aster-Adaptive-Computing.md) | [AI Projects index and assessment](AI%20Projects/README.md); replaces five archived standalone assistant plans; retains AI-PAM and operational dependencies |
...
| AI Privileged Access Management (AI-PAM) / credential broker | Active — Stream A; M0–M7 complete, M8 integration/native parity in progress | [AI-PAM and credential broker](homelab-credential-broker.md) | Recoverable OpenBao, lifecycle/approval management, bounded Forgejo read/write and brokered Lab Doctor Green/Yellow paths are live; service-onboarding governance is adopted and native macOS parity is the next implementation gate |
