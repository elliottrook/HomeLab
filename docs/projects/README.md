...
| Aster mirror directory-first retrieval | Active — Stream A; Milestones 1–4 complete, production decision pending | [Aster mirror directory-first retrieval](Aster-Mirror-Directory-Retrieval.md) | Directory-first retrieval improves top rank from 6/10 to 8/10 with zero regressions and passes two complete 60-behavior live runs; rollback and drift monitoring are proven, while activation and credential rotation remain explicit approval gates |
