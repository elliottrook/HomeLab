...
| AI Privileged Access Management (AI-PAM) / credential broker | Graduation complete locally — publication/archival pending | [AI-PAM and credential broker](homelab-credential-broker.md) | M0–M9 pass: recoverable OpenBao, lifecycle/approval management, bounded Forgejo/Doctor paths, native parity, policy-drift monitoring, dependency fail-closed behavior, restart recovery and independent human administration are evidenced |
