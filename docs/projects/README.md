...
|---|---|---|---|
| Authentik rollout | Active — redesigned under the Project Creation Standard, Stream M; Milestone 2 (Homepage, Beszel) reset after a stalled unattended attempt | [Authentik rollout](Authentik-Rollout.md) | [Authorization runbook](../08-Authorization.md), [service onboarding](../09-Service-Authorization-Onboarding.md) |
...
| Aster offline knowledge wiki and mirror | Graduated | [Aster offline knowledge wiki and mirror](Aster-Offline-Knowledge-Wiki.md) | Stream A private human-focused manuals/wiki corpus with daily allowlisted updates and a separate provenance-preserving, non-authoritative Aster analysis mirror |
| Aster production corpus expansion | Proposed — Stream A authorization pending | [Aster production corpus expansion](Aster-Production-Corpus-Expansion.md) | Version-matched official Git documentation, vendor manuals and reviewed local references for the deployed ARR, Home Assistant, infrastructure and hardware estate |
