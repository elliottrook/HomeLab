...
- Homepage includes network, virtualization, storage, media, media-automation, application-management, external-service, SSH-access and surveillance groups. Frigate web and SSH tiles are operational. The dashboard and its internal management targets remain intended for LAN or Tailscale access only.
