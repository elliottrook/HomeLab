...
- Provisioned `jason@yampy.ca` as Grafana's sole alert contact. A controlled test reached local Postfix but exposed the expected residential outbound-TCP-25 block; the test rule/message were cleaned up and SMTP remains disabled pending an authenticated 465/587 relay.
