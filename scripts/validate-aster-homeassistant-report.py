#!/usr/bin/env python3
"""Validate a candidate sanitized Home Assistant report without contacting any service."""
...
from home_assistant_report import get_home_assistant_report  # noqa: E402
...
def main() -> int:
    ...
    result = get_home_assistant_report(args.report, freshness_seconds=args.freshness_seconds)
