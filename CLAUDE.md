...
| Aster Speech LXC 116 | 192.168.70.14 | STT/TTS service health and deployment (Aster-Companion-App M6) |
...
`docs/handovers/UPS-Power-Resilience-Claude-Handover.md` (5-milestone tracker + 26-item
...
- Resolved 2026-08-24: apt/DNS resolution failure on the Lenovo box was caused
  ...
  Details in `docs/handovers/UPS-Power-Resilience-Claude-Handover.md` (Milestone 1).
...
- 2026-08-28: Milestone 1 fully closed (hardware inventoried, hostname/
  ...
  Full details in `docs/handovers/UPS-Power-Resilience-Claude-Handover.md`.
...
- **Corrected 2026-08-29**: the final equipment distribution across the
  ...
  `docs/handovers/UPS-Power-Resilience-Claude-Handover.md` (Section 6) has been
  updated to match.
...
- 2026-08-29: Milestone 3 in progress. Proxmox is now a NUT network
  ...
  `docs/handovers/UPS-Power-Resilience-Claude-Handover.md` (Milestone 3 tracker).
