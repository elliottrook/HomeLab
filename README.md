...
- Home Assistant OS VM 103 is operational at `home-assistant.home.internal` on Servers VLAN 20; Philips Hue and Lutron Caséta are integrated and the Hue-to-Lutron pilot awaits recovery of a Hue motion sensor.
...
- `lab doctor` functionally monitors OPNsense, Arista, Proxmox, TrueNAS, Frigate, both Pi-holes and backup-report freshness using persistent counter baselines where appropriate.
