...
- Homepage provides the internal service dashboard at `http://home.internal:3000`.
...
- Tailscale provides identity-restricted remote access to the trusted LAN without inbound WAN ports.
